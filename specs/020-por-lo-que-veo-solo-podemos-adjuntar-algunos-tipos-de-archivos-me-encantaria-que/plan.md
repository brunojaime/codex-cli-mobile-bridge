...
- DEV implementation commit: `8e5b88f Support office document attachments`.
- DEV branch refreshed with `dev/main`: `8aa327b Merge branch 'dev/main' into dev/spec-020-por-lo-que-veo-solo-podemos-adjuntar-algunos-tipos-de-archivos-me-encantaria-que`.
...
- `git diff --check`: passed after merging `dev/main`.
