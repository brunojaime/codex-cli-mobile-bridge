...
def _mobile_config_dart() -> str:
  ...
  const AppConfig({required this.apiBaseUrl, required this.runtimeProfile});
  ...
  bool get isConfigured =>
      isMock || (apiBaseUrl != null && apiBaseUrl!.isNotEmpty);

  String get errorMessage {
    if (runtimeProfile != 'mock' &&
        runtimeProfile != 'real' &&
        runtimeProfile != 'staging') {
      return 'APP_RUNTIME_PROFILE must be mock, real, or staging.';
    }
