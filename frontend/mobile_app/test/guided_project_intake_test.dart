...
void main() {
  ...
  testWidgets('New Project opens persisted guided intake and live answers',
    ...
    await tester.enterText(_composerField(), 'ok, dale para adelante');
  ...
  testWidgets(
    ...
    await _sendComposerMessage(tester, 'ok, dale para adelante');
  ...
  testWidgets(
    ...
    await _answerGuidedIntakeQuestion(tester);
    await _sendComposerMessage(tester, 'dale');
  ...
  testWidgets('cancelled init and poll errors do not start Domain Factory',
      (tester) async {
    final apiClient = _GuidedProjectApiClient()
      ..initPollJobs = <ProjectFactoryInitJob>[
        _initJob(
