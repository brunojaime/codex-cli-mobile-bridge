...
void main() {
  ...
  testWidgets('shares the complete charter by email from a narrow phone', (
    WidgetTester tester,
  ) async {
    final apiClient = _ProjectDocumentsPanelApiClient();
    ...
    await _pumpPanel(tester, apiClient: apiClient);
    await tester.ensureVisible(find.text('Compartir por correo'));
    await tester.tap(find.text('Compartir por correo'));
    await tester.pumpAndSettle();

    expect(find.text('Compartir Acta de Proyecto'), findsOneWidget);
    expect(find.text('Incluir documento completo'), findsOneWidget);
    final checkbox = tester.widget<Checkbox>(find.byType(Checkbox));
    expect(checkbox.value, isTrue);
    await tester.enterText(
      find.widgetWithText(TextField, 'Destinatarios'),
    ...
    expect(apiClient.sharedRecipients, <String>[
      'owner@example.com',
...
class _ProjectDocumentsPanelApiClient extends ApiClient {
  ...
  @override
  Future<Map<String, dynamic>> shareProjectDocumentCharter({
    ...
    sharedRecipients
      ..clear()
      ..addAll(recipients);
    sharedFullDocument = includeFullDocument;
